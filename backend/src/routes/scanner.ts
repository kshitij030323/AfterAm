...
const eventSchema = z.object({
    ...
    stagPrice: z.number().min(0).default(0),
    couplePrice: z.number().min(0).default(0),
    ladiesPrice: z.number().min(0).default(0),
    date: z.string(),
    startTime: z.string(),
    endTime: z.string(),
    ...
    try {
        ...
        const event = await prisma.event.create({
            data: {
                ...
                stagPrice: data.stagPrice,
                couplePrice: data.couplePrice,
                ladiesPrice: data.ladiesPrice,
